    ...
    try {
      ...
      if (users != null) {
        ...
        Get.find<GetStorageService>().setUserDataStorage(
          ...
          userCredentials[0].userToken,
          userCredentials[0].userCode,
          userCredentials[0].userEmailAddress,
          userCredentials[0].userPassword,
